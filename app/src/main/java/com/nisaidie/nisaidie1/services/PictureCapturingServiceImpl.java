...
public class PictureCapturingServiceImpl extends APictureCapturingService {
    ...
    /*@Override
    public void startCapturing(View.OnClickListener listener) {
    ...
    */
    ...
    private void saveImageToDisk(final byte[] bytes) {
        final File file = new File(Environment.getExternalStorageDirectory() + "/nisaidie/" + this.cameraDevice.getId() +"_"+s.toString()+ "_pic.jpg");
